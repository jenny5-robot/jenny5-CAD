...
module dc_motor_housing(motor_offset_x, motor_offset_y, motor_radius, motor_length, base_height, motor_center_hole_radius, motor_holes_position, base_thick)
{
	...
	difference(){
		...
		translate([base_thick + motor_offset_x, side_wall_dc_motor_housing_thick + airflow_spacer + motor_offset_y, 0] + [motor_radius + airflow_spacer_x, motor_radius, 0]- display_tolerance_z) {
            // center motor hole
