...
//-------------------------------------------------------------------------
module tube_bracket_long_one_hole(bracket_length, tube_radius)
{
    bracket_width = f_bracket_width(tube_radius);
    bracket_height = f_bracket_height_strong(tube_radius);
    
    holes = f_tube_bracket_single_hole(bracket_length, tube_radius);
...
tube_bracket_long_one_hole(bracket_length = 12, tube_radius = 12.5);
