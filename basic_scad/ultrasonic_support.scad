...
module hc_sr04_arm()
{
    ...
    difference(){
      color(plastic_color) 
        ...
        // bone's hole
        translate ([hc_sr04_arm_sizes[0] - 4 - 6, hc_sr04_arm_sizes[1] / 2, 0] - [0, 0, thick_sheet] - display_tolerance_z) cylinder (h = hc_sr04_arm_sizes[2] + thick_sheet + 2 * display_tolerance, r = 6);
        // other hole
        translate ([4, 5, 0] - [0, 0, thick_sheet] - display_tolerance_z) cube([10, hc_sr04_arm_sizes[1] - 10, hc_sr04_arm_sizes[1]] + [0, 0, thick_sheet] + 2 * display_tolerance_z);
...
//   
          translate ([hc_sr04_arm_sizes[0] - 4 - 6 - 15, hc_sr04_arm_sizes[1] / 2, 0] - [0, 0, thick_sheet] - display_tolerance_z) cylinder (h = hc_sr04_arm_sizes[2] + thick_sheet + 2 * display_tolerance, r = 2, $fn = 10);
