...
//--------------------------------------------------------------
module stepper_gearbox_motor_sheet(sheet_size, gearbox_hole_position, screw_hole_position, gearbox_hole_radius, gearbox_radius, rotate_screw_holes)
{
    difference(){
...
//--------------------------------------------------------------
module stepper_gearbox_nema_17_motor_sheet()
{
    stepper_gearbox_motor_sheet(nema_17_gearbox_sheet_size, gearbox_nema_17_holes_position, nema17_gearbox_tensioner_sheet_screw_hole_position, nema_17_gearbox_motor_hole_radius, nema_17_motor_gearbox_radius, 0);
}
//--------------------------------------------------------------
module stepper_gearbox_nema_11_motor_sheet()
{
    stepper_gearbox_motor_sheet(nema_11_gearbox_sheet_size, gearbox_nema_11_holes_position, nema11_gearbox_tensioner_sheet_screw_hole_position, nema_11_motor_gearbox_hole_radius, nema_11_motor_gearbox_radius, 45);
}
//--------------------------------------------------------------

stepper_gearbox_nema_11_motor_sheet();