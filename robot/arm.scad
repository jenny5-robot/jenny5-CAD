...
module body_arm_traction_pulley()
{
    difference(){
        ...
        // nut hole
        hull(){
            translate ([10, 0, 5.5]) rotate ([0, 90, 0]) cylinder(h = m4_nut_thick + 0.3, r = m4_nut_radius, $fn = 6);
            translate ([10, 0, 11]) rotate ([0, 90, 0]) cylinder(h = m4_nut_thick + 0.3, r = m4_nut_radius, $fn = 6);
        }
    }
}
//---------------------------------------------------------------------------
